...
void AboutInterface::initData(){
    ...
    versionOutput.append(QString("%1%2%3<br>").arg(tr("Build date")).arg(":").arg(data.buildDate.toString()));
    versionOutput.append(QString("%1%2%3<br>").arg(tr("Build time")).arg(":").arg(data.buildTime.toString()));
...
void AboutInterface::setupLibraries(){
    ...
    this->ui->LibrariesDisplay->insertHtml(QString("%1 ").arg(HtmlProcFont(QString(tr("Beacon Qt Library")).append(":").append(version.BeaconLibVersion),fontLib.targetFontName)));
...
void AboutInterface::setupAuthors(){
    QLabel *bugAddressLabel = new QLabel(QString(tr("Please report bugs to")).append(" ").append("Beacon1096@outlook.com"),this->ui->AuthorsTab);
    ...
    addAuthor(tr("Beacon1096"),tr("Programming").append(",").append(tr("Core Processing Backend")),"Beacon1096@outlook.com","http://www.codeaha.com/","Github->Beacon1096,QQ->505173168");
    addAuthor(tr("Polaris1087"),tr("UI Frontend").append(",").append(tr("Translation")),"Polaris1087@outlook.com","http://www.codeaha.com/","");
...
void AboutInterface::addAuthor(QString name, QString job, QString emailAddress, QString homePage, QString IM){
    ...
    if(!emailAddress.isEmpty()){
        ...
        emailButton->setToolTip(QString(tr("email to")).append(":\n").append("mailto:").append(emailAddress));
    ...
    if(!homePage.isEmpty()){
        ...
        homePageButton->setToolTip(QString(tr("Visit homepage")).append(":\n").append(homePage));
    ...
    if(!IM.isEmpty()){
        ...
        IMButton->setToolTip(QString(tr("Contact contributer at")).append(":\n").append(IM));
